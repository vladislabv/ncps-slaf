...
# CREATE CLEANED DATA AND FEATURES
...
# CREATE ARIMA MODEL AND PROPHET MODEL
...
# LOAD STATISTICAL MODELS AND MAKE FORECAST, ALSO PLOTS FOR FORECASTS
...
# LOAD LNN AND LNN+SLAF MODELS AND MAKE FORECAST, CALCULATE METRICS (FOR 10 EPOCHS)
...
# LOAD LNN AND LNN+SLAF MODELS AND MAKE FORECAST, CALCULATE METRICS (FOR 100 EPOCHS)
...
# PLOT RESULTS FOR LNN AND LNN+SLAF
